...
public class OrderItem extends JPanel{
	...
	public OrderItem(OrderDetailVO vo) {
...
//				g.fillRect(0, 0, 100, 100);
		...
		p_info = new JPanel();
		la_brand = new JLabel(vo.getBrand() + "/" + vo.getProduct_name() + "/" + myFormat.format(vo.getPrice()*vo.getNumProduct()) + "원",SwingConstants.CENTER);
