...
import com.shoppingmall.admin.member.Member;
import com.shoppingmall.admin.order.Order;
import com.shoppingmall.admin.product.Product;
...
public class AdminMain extends JFrame{
	...
	String [] navi_title = {"상품관리","회원정보","주문관리","게시판관리","Log Out"};
	...
	public AdminMain(int member_id) {
