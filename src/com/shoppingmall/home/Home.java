...
public class Home extends Page{
	...
	public Home(ShopMain shopMain) {
		...
		p_content.setPreferredSize(new Dimension(ShopMain.WIDTH-40,ShopMain.HEIGHT-200));
		p_content.setBackground(new Color(15,76,129));
		p_content.setBorder(new TitledBorder(null, "NEW", TitledBorder.LEADING, TitledBorder.TOP, new Font("맑은 고딕", Font.PLAIN, 30), Color.WHITE));
